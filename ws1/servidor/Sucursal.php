...
//--METODO DE CLASE
	...
	{	
		...
		$consulta =$objetoAccesoDato->RetornarConsulta("SELECT * FROM sucursales WHERE id_sucursal=:idSuc");
	...
	{	
		$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
		$consulta =$objetoAccesoDato->RetornarConsulta("DELETE FROM sucursales WHERE id_sucursal=:idSuc");
...
//--------------------------------------------------------------------------------//
	...
	{
		$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
		$consulta =$objetoAccesoDato->RetornarConsulta("INSERT into sucursales (nombre,direccion,localidad,telefono,encargado,foto1,foto2,foto3) values(:nombre,:direccion,:localidad,:telefono,:encargado,:foto1,:foto2,:foto3)");
